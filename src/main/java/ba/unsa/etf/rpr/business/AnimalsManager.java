...
public class AnimalsManager {
    ...
    public List<Animals> searchByName(String text) throws FarmVetException {
        return DaoFactory.animalsDao().searchByName(text);
    }
    public Animals add(Animals animal) throws FarmVetException {
        if (animal.getId() != 0) {
            throw new FarmVetException("Can't add animal with ID. ID is autogenerated");
        }
        ...
        try {
            ...
            if (e.getMessage().contains("UQ_NAME")) {
                throw new FarmVetException("Animal with same name exists");
            }
            throw e;
        }
    }
    ...
    public List<Animals> getAll() throws FarmVetException{
        return DaoFactory.animalsDao().getAll();
    }
}